...
## Corpus Check
- 1488 files · ~9,525,009 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3178 nodes · 4381 edges · 241 communities (218 shown, 23 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `329a5eb9`
...
## Communities (241 total, 23 thin omitted)
...
Cohesion: 0.19
Nodes (9): categoryMeta, categoryProjects, ../../components/ui/features/Hero.astro, ../../../../layouts/BaseLayout.astro, canonicalURL, ../../../../layouts/Footer.astro, categories, @repo/randomart/renderPixelMapAsBase64 (+1 more)
...
Cohesion: 0.24
Nodes (5): ../../components/ui/docs/DocNav.astro, categories, ../../../../components/ui/features/SectionHeader.astro, tagMeta, tagProjects
...
Cohesion: 0.15
Nodes (14): initGraphData(), GraphDataState, EdgeBuffers, Community, communitySchema, graphDataSchema, GraphLink, graphLinkSchema (+6 more)
...
Cohesion: 0.24
Nodes (8): ./BaseCard.astro, ../cards/CategoryCard.astro, ../../components/ui/cards/DocCard.astro, ../../../../components/ui/cards/ExperimentCard.astro, ../components/ui/docs/FeaturedDocs.astro, hasActiveArticle, @repo/ui/Icon, @repo/ui/icons
...
Cohesion: 0.50
Nodes (4): ../components/ui/features/ExperimentsPreview.astro, groups, ../components/ui/projects/FeaturedProjects.astro, featuredProjects
...
Cohesion: 0.25
Nodes (12): useLinks(), useNodes(), graphDataStore, computeEdgeBuffers(), DetailsPanel(), getStats(), GraphOverview(), Stat() (+4 more)
...
Cohesion: 0.25
Nodes (6): buildTree(), evaluateNode(), ExpressionNode, renderPixelBuffer(), renderPixelMapAsBase64(), SeededRandom
...
## Knowledge Gaps
- **1727 isolated node(s):** `isVercel`, `name`, `type`, `version`, `node` (+1722 more)
