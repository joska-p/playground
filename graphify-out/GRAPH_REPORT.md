...
## Corpus Check
- 312 files · ~81,884 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2438 nodes · 3084 edges · 242 communities (187 shown, 55 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8dc909bb`
...
1. `cn()` - 34 edges
2. `exports` - 31 edges
3. `../../layouts/base-layout.astro` - 25 edges
4. `graphStore` - 21 edges
5. `useGraphSimulation` - 18 edges
...
Cohesion: 0.09
Nodes (22): devDependencies, @babel/core, babel-plugin-react-compiler, eslint, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, prettier (+14 more)
...
Cohesion: 0.25
Nodes (8): ./base-card.astro, ../../components/ui/cards/doc-card.astro, ../../components/ui/docs/doc-nav.astro, formattedType, { Icon }, getCategoryMetadata(), getDocsByCategory(), ../../data/docs
...
Cohesion: 0.09
Nodes (22): dependencies, astro, @astrojs/check, @astrojs/mdx, @astrojs/react, lucide-react, react, react-dom (+14 more)
...
Cohesion: 0.10
Nodes (19): docSchema, CATEGORY_METADATA, CategoryId, categoryIds, docSchema, getFeaturedDocs(), categoriesIds, CATEGORY_METADATA (+11 more)
...
Cohesion: 0.09
Nodes (31): SequenceRenderer(), SequenceSelector(), generateSequence(), collatzRule, fibonacciRule, NextStepParams, primesRule, recamanRule (+23 more)
...
Cohesion: 0.04
Nodes (44): dependencies, d3, react, react-dom, @repo/ui, @types/d3, zustand, devDependencies (+36 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (37): devDependencies, @babel/core, babel-plugin-react-compiler, eslint, prettier, prettier-plugin-organize-imports, prettier-plugin-tailwindcss, react (+29 more)
...
Cohesion: 0.05
Nodes (42): dependencies, react, react-dom, @repo/ui, zustand, devDependencies, @babel/core, babel-plugin-react-compiler (+34 more)
...
Cohesion: 0.14
Nodes (19): defaultTileSet, TileNames, TileSet, computeInitialTiles(), generateTileColors(), generateTileRotation(), initMosaicPalettes(), MosaicState (+11 more)

### Community 94 - "Community 94"
Cohesion: 0.09
Nodes (21): Codebase Conventions, code:typescript (// Button.tsx → exports Button, ButtonProps), code:typescript (// ✅ React component — function declaration), code:typescript (// sequenceStore.ts — file name: camelCase.ts), code:block4 (features/color-palette/), code:typescript (// colorPalette.schema.ts), code:block6 (ColorPalette.tsx          → ColorPalette.test.tsx), code:json ({) (+13 more)
...
Cohesion: 0.11
Nodes (26): ../../../../components/data-viz/pie-chart/pie-chart.astro, ../../../components/ui/cards/experiment-card.astro, ../../components/ui/features/hero.astro, ../../layouts/base-layout.astro, CATEGORIES, Category, getProjectsByCategory(), Project (+18 more)
...
Cohesion: 0.15
Nodes (12): dependencies, react, react-dom, @repo/ui, zod, zustand, dependencies, react (+4 more)

### Community 102 - "Community 102"
Cohesion: 0.09
Nodes (21): Demo(), ImageToParticles(), Particle, config, INITIAL_VELOCITY, PARTICLE_SIZE, calculateImageDimensions(), drawImageToCanvas() (+13 more)
...
Cohesion: 0.17
Nodes (8): ../../layouts/footer.astro, getNotesByCategory(), [], credits, date, formatedDate, options, ../../data/notebook
...
Cohesion: 0.15
Nodes (10): MosaicMaker(), defaultGapSize, defaultRotations, defaultTileSize, CSS_VARS, Dimensions, useResizeObserver(), MOSAIC_STYLES (+2 more)
...
Cohesion: 0.11
Nodes (17): code:block1 (HTMLImageElement), code:bash (pnpm add @repo/image-manipulator), code:ts (type RGBA = { r: number; g: number; b: number; a: number };), code:ts (import { pipe, fork } from "@repo/image-manipulator";), code:ts (import type { PixelCallback } from "@repo/image-manipulator"), code:tsx (import { ImageManipulator } from "@repo/image-manipulator";), code:ts (import { useImageUpload } from "@repo/image-manipulator";), Core primitives (+9 more)
...
Cohesion: 0.22
Nodes (12): PaletteControls(), SliderControls(), SliderControlsProps, Controls(), mosaicStore, useMosaicCurrentPalette(), useMosaicCurrentPalettes(), useMosaicRef() (+4 more)
...
Cohesion: 0.13
Nodes (6): active, [], active, ./scripts/mobileMenu.js, ./scripts/smartNavbar.js, ./scripts/theme.js
...
Cohesion: 0.20
Nodes (9): code:text (Si nous pouvons additionner, pouvons-nous inverser l'opérati), code:text (i n'est pas dans le monde réel. Il ne se trouve pas sur la d), Épilogue — La Formule d'Euler, Étape 01 — Les Entiers Naturels — $\mathbb{N}$, Étape 02 — Le Zéro et les Négatifs — $\mathbb{Z}$, Étape 03 — Les Nombres Rationnels — $\mathbb{Q}$, Étape 04 — Les Nombres Réels — $\mathbb{R}$, Étape 05 — L'Unité Imaginaire — $\mathbb{i}$ (+1 more)
...
Cohesion: 0.26
Nodes (8): CachedPalettes, cachePalettes(), colorNames, fetchPalettes(), getCachedPalettes(), isCacheValid(), paletteSchema, safeFetch()

### Community 137 - "Community 137"
Cohesion: 0.14
Nodes (13): Built With, code:bash (mkdir .container_home   # only once — persists shell state a), code:bash (pnpm install && pnpm dev), code:bash (pnpm install && pnpm dev), Creative Playground, Dev Container (Recommended), Documentation, License (+5 more)
...
Cohesion: 0.25
Nodes (7): TileSetControls(), Shape, TILE_REGISTRY, TileDefinition, useMosaicTileSet(), Tile(), TileProps

### Community 141 - "Community 141"
Cohesion: 0.18
Nodes (10): code:block1 (apps/), code:block15 (packages/ui/src/widgets/color-palette/), Component folder structure, Edge cases, File extensions, Monorepo structure, Project Conventions, Quick rules (+2 more)
...
Cohesion: 0.20
Nodes (10): tailwindcss, tailwindcss, tailwindcss, tailwindcss, tailwindcss, tailwindcss, tailwindcss, tailwindcss (+2 more)

### Community 145 - "Community 145"
Cohesion: 0.20
Nodes (10): code:ts (// graphStore.ts), code:block7 (features/graph/), code:ts (export function useGraphNodes(): GraphNode[] {), code:ts (export function addGraphNode(node: GraphNode): void {), File structure, Full example, Getters — reactive hooks, Rules (+2 more)
...
Cohesion: 0.44
Nodes (5): defaultPalette, Palette, updateMosaicPalette(), arePalettesEqual(), getPaletteId()
...
Cohesion: 0.18
Nodes (7): remarkBaseUrl(), isVercel, AccentBottom, meta, NormalLeft, PrimaryRight, SecondaryTop

### Community 157 - "Community 157"
Cohesion: 0.22
Nodes (9): code:block17 (packages/eslint-config/), code:json (// packages/eslint-config/package.json), code:js (// packages/eslint-config/index.js), code:js (import { defineConfig } from "eslint/config";), code:json ({), Rules enforced automatically, Rules enforced by convention only (no lint rule yet), Shared ESLint config (+1 more)
...
Cohesion: 0.22
Nodes (9): scripts, build, check-types, dev, format, lint, lint-fix, astro (+1 more)

### Community 160 - "Community 160"
Cohesion: 0.13
Nodes (18): scripts, build, check-types, dev, format, lint, lint-fix, scripts (+10 more)

### Community 161 - "Community 161"
Cohesion: 0.29
Nodes (6): code:sh (pnpm create astro@latest -- --template basics), code:text (/), Astro Starter Kit: Basics, 🧞 Commands, 🚀 Project Structure, 👀 Want to learn more?
...
Cohesion: 0.16
Nodes (13): ../components/ui/docs/featured-docs.astro, ../../components/ui/features/section-header.astro, ../components/ui/features/stats.astro, ../components/ui/projects/featured-projects.astro, getFeaturedProjects(), featuredProjects, dependencies, class-variance-authority (+5 more)

### Community 169 - "Community 169"
Cohesion: 0.33
Nodes (5): AccentLarge, meta, PrimaryHorizontal, SecondaryVertical, SmallCompact
...
Cohesion: 0.33
Nodes (5): code:bash (pnpm add @repo/mosaic-maker), code:tsx (import { MosaicMaker } from "@repo/mosaic-maker";), 🧠 Core Concepts, 🚀 Quick Start, @repo/mosaic-maker

### Community 172 - "Community 172"
Cohesion: 0.33
Nodes (6): code:json ({), `dependencies`, `devDependencies`, Package dependencies, `peerDependencies`, Quick reference

### Community 173 - "Community 173"
Cohesion: 0.33
Nodes (6): code:ts (// Button.tsx), code:json ({), code:ts (import { Button } from "@repo/ui/Button";), Exports, In-code, Package exports (`package.json`)
...
Cohesion: 0.40
Nodes (5): code:ts (// ✅ React component — function declaration), code:ts (// ✅ infer — obvious return type), Declarations vs arrows, Function syntax, Return types

### Community 199 - "Community 199"
Cohesion: 0.67
Nodes (3): Casing by entity, Casing by identifier (in-code), Naming conventions

### Community 200 - "Community 200"
Cohesion: 0.67
Nodes (3): code:block11 (features/color-palette/), code:ts (// colorPalette.schema.ts), Zod schemas

### Community 201 - "Community 201"
Cohesion: 0.67
Nodes (3): code:block13 (apps/storybook/), code:ts (// apps/storybook/stories/ui/Button.stories.tsx), Storybook
...
Cohesion: 0.14
Nodes (13): Adding to the Playground Website, After Generation, code:bash (pnpm gen new-package), code:bash (pnpm gen new-package --args my-visualization), code:block3 (packages/<name>/), code:bash (pnpm install), code:astro (---), code:block6 (turbo/generators/) (+5 more)
...
## Knowledge Gaps
- **1284 isolated node(s):** `../../../../layouts/base-layout.astro`, `../../../../components/ui/features/hero.astro`, `Step 01 — The Natural Numbers — <span class="text-accent">$\mathbb{N}$</span>`, `Step 02 — Zero and the Negatives — <span class="text-accent">$\mathbb{Z}$</span>`, `Step 03 — The Rational Numbers — <span class="text-accent">$\mathbb{Q}$</span>` (+1279 more)
...
- **Why does `dependencies` connect `Community 7` to `Community 144`, `Community 146`, `Community 11`, `Community 6`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `Community 86` to `Community 144`?**
...
- **What connects `../../../../layouts/base-layout.astro`, `../../../../components/ui/features/hero.astro`, `Step 01 — The Natural Numbers — <span class="text-accent">$\mathbb{N}$</span>` to the rest of the system?**
