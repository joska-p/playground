# Graph Report - playground  (2026-05-27)

## Corpus Check
- 292 files · ~78,061 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2286 nodes · 2900 edges · 227 communities (171 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53944eca`
...
## Communities (227 total, 56 thin omitted)
...
Cohesion: 0.10
Nodes (20): devDependencies, @babel/core, babel-plugin-react-compiler, eslint, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, prettier (+12 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (44): exports, ./Badge, ./badgeVariants, ./blade-runner-theme, ./Button, ./buttonVariants, ./candy-coated-theme, ./Card (+36 more)
...
Cohesion: 0.19
Nodes (13): devDependencies, prettier, prettier-plugin-astro, prettier-plugin-organize-imports, prettier-plugin-tailwindcss, devDependencies, eslint, eslint-plugin-astro (+5 more)
...
Cohesion: 0.20
Nodes (9): code:text (Apply it once 1 + 1 = 2), code:text (5 - 2 = 3), Epilogue — Euler's Formula, Step 01 — The Natural Numbers — $\mathbb{N}$, Step 02 — Zero and the Negatives — $\mathbb{Z}$, Step 03 — The Rational Numbers — $\mathbb{Q}$, Step 04 — Logarithms, Step 05 — The Imaginary Unit — $\mathbb{i}$ (+1 more)
...
Cohesion: 0.05
Nodes (40): dependencies, colorjs.io, react, react-dom, @repo/ui, zustand, devDependencies, @babel/core (+32 more)

### Community 87 - "Community 87"
Cohesion: 0.05
Nodes (38): dependencies, d3, react, react-dom, @repo/ui, @types/d3, zustand, devDependencies (+30 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (38): dependencies, react, react-dom, @repo/ui, zod, zustand, devDependencies, @babel/core (+30 more)
...
Cohesion: 0.05
Nodes (37): dependencies, react, react-dom, @repo/ui, zustand, devDependencies, @babel/core, babel-plugin-react-compiler (+29 more)
...
Cohesion: 0.09
Nodes (21): devDependencies, prettier, prettier-plugin-astro, prettier-plugin-organize-imports, prettier-plugin-tailwindcss, engines, node, name (+13 more)
...
Cohesion: 0.14
Nodes (13): ../../../../components/data-viz/pie-chart/pie-chart.astro, ../../components/ui/features/hero.astro, projects, @repo/graph-viz, @repo/image-to-particles, @repo/image-to-particles/ImageToParticles, @repo/mosaic-maker, @repo/mosaic-maker/MosaicMaker (+5 more)
...
Cohesion: 0.15
Nodes (11): ImageToParticles(), Particle, config, INITIAL_VELOCITY, PARTICLE_SIZE, calculateImageDimensions(), drawImageToCanvas(), ImageDimensions (+3 more)
...
Cohesion: 0.24
Nodes (11): ../../../components/ui/cards/experiment-card.astro, ../components/ui/projects/featured-projects.astro, CATEGORIES, Category, getFeaturedProjects(), getProjectsByCategory(), Project, @repo/image-manipulator/ImageManipulator (+3 more)
...
Cohesion: 0.17
Nodes (11): Built With, code:bash (pnpm install && pnpm dev), Creative Playground, Dev Container (Recommended), Documentation, License, Manual Setup, Quick Start (+3 more)
...
Cohesion: 0.25
Nodes (8): scripts, build, check-types, dev, format, lint, lint-fix, astro
...
## Knowledge Gaps
- **1210 isolated node(s):** `$schema`, `ui`, `dependsOn`, `inputs`, `outputs` (+1205 more)
