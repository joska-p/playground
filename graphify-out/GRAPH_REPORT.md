# Graph Report - playground  (2026-04-30)

## Corpus Check
- 92 files · ~31,170 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 198 nodes · 211 edges · 11 communities detected
...
Cohesion: 0.26
Nodes (8): hexToHSL(), hexToRGB(), HSLToHex(), HSLToRGB(), hueToRGB(), RGBToHex(), RGBToHSL(), getPixelColor()
