...
u es chargé d'exécuter la refonte UI du monorepo étape par étape, en respectant un style "Creative Coding / Brutaliste" basé sur un thème OKLCH strict.
...
- Crée le fichier `HANDOFF.md` à la racine avec le bilan de la Phase 1 et les instructions pour la Phase 2 (Migration des couleurs Tailwind hors-thème).  i y a un rapport detaillé '/workspaces/playground/drafts/ui-design/ui-library-usage-report.md' mais pas besoin normalement de le lire.