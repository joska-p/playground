You are an expert TypeScript Graphics Architect completing the audit of the `core/` folder in `glaze`.
...
4. At the very end of `GLAZE_REFACTOR_INVENTORY.md`, add a "Recommended Order of Refactoring for core/" summary list, ordering the tasks from lowest-level leaves (math/utilities) up to high-level core modules.

Do NOT refactor any code yet. Just finalize `GLAZE_REFACTOR_INVENTORY.md`.