...
4. At the very end of `GLAZE_REFACTOR_INVENTORY.md`, add a "Recommended Order of Refactoring for cpu/" summary list, ordering the tasks from lowest-level leaves (math/utilities) up to high-level core modules.
