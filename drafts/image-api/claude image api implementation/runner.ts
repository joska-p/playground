import { ManipulationDefinition, PixelFn, NeighborhoodFn, WholeImageFn, Step, PipelineResult } from './types'
...
export async function runPipeline(source: ImageData, steps: readonly Step[]): Promise<PipelineResult> {
