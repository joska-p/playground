/**
 * Decide whether a given file is "generated" (regenerated by a build step, unsafe to write variants
 * into) or "source" (safe to edit, changes persist).
 *
 * Why this matters: when the user picks an element on a page whose underlying file is regenerated
 * by a build step (e.g. `scripts/build-sub-pages.js` rewriting `public/docs/*.html`), writing
 * variants or accepted changes into that file is silent data loss — the next build wipes them.
 *
 * Signals, in order of reliability:
 *
 * 1. Git check-ignore: gitignored files are assumed generated.
 * 2. File-header markers ("GENERATED", "DO NOT EDIT", "AUTO-GENERATED") within the first ~300
 *    characters — catches non-git projects.
 */
