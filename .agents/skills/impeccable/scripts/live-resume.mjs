...
/**
 * The browser's render truth, folded into a small block the agent reads before it decides what to
 * do. `arrivedVariants` only says the agent published; `renderState` says whether any of it reached
 * a screen.
 */
