 ...
 *
 * Reads .impeccable/live/pending-manual-edits.json, drops entries, writes back. No source-file
 * writes. Use this when the user wants to throw away unsaved manual edits.
 *
 * Trigger: only when the user explicitly asks the AI to discard / throw away / clear pending manual
 * edits.
 *
 * Usage: node live-discard-manual-edits.mjs # discard all pending node
 * live-discard-manual-edits.mjs --page-url=/ # discard only entries for "/"
 *
