 ...
 *
 * Kept separate from live-browser.js so recovery state can be tested without booting the full
 * overlay UI. Served before live-browser.js and attached to window.**IMPECCABLE_LIVE_SESSION**.
 */
(function (root) {
    'use strict';
