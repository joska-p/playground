 ...
 *
 * Astro takes the generic tag strategy, with two Astro-specific values that used to sit as inline
 * `endsWith('.astro')` branches in live-inject.mjs and live-wrap.mjs:
 *
