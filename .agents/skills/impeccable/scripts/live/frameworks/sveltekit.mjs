 ...
 *
 * Detection and the apply/remove pair are the existing adapter's (`../sveltekit-adapter.mjs`); this
 * file only declares them to the registry and names the artifacts the journal has to be able to
 * heal.
 */
