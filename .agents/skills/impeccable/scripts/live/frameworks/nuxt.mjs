 ...
 *
 * A script element placed in app.vue is compiled as Vue-rendered DOM and is not executed. Nuxt
 * instead auto-discovers client plugins. Keep the adapter generated, dev-only, and outside
 * user-authored source: Live creates one marked .client.ts plugin on start and removes it on stop.
 */
