 ...
 *
 * This module intentionally does not edit source files and does not choose a winner. It gathers
 * staged browser edits, rendered context, framework source hints, and likely source candidates so
 * the AI copy-edit batch runner can make source changes with full repo context.
 */
