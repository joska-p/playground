 ...
 *
 * Usage: node <scripts_path>/pin.mjs pin <command> node <scripts_path>/pin.mjs unpin <command>
 *
 ...
 *
 * The script discovers harness directories (.claude/skills, .cursor/skills, etc.) in the project
 * root and creates/removes the pin in all of them.
 */
