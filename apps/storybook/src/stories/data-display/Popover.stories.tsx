        ...
        <div className="flex flex-wrap justify-center gap-8 px-4 pt-48">
            ...
            >
                ...
                <p className="text-foreground-muted text-xs leading-relaxed">
                    Controls the base frequency of the noise function used to generate the terrain
                    heightmap. Higher values produce more detailed, rougher surfaces while lower
                    values create smoother, rolling landscapes.
                </p>
            </Popover>
        </div>
    )
