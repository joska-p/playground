...
const slides = [
        {
                ...
                description: 'A flowing wave pattern driven by Perlin noise.'
        },
        {
                title: 'Particle System',
                description: 'Thousands of interactive particles with gravity.'
        },
        {
                title: 'Fractal Explorer',
                description: 'Navigate the Mandelbrot set at any zoom level.'
        },
        { title: 'Fluid Simulation', description: 'Real-time fluid dynamics with colorful dyes.' },
        {
                title: 'Cellular Automata',
                description: 'Conway&#8217;s Game of Life with custom rules.'
        },
        {
                title: 'Generative Waves',
                description: 'A flowing wave pattern driven by Perlin noise.'
