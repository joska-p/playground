        ...
        render: () => (
                <Accordion>
                        <AccordionItem title="What is this playground?">
                                A creative sandbox for experimenting with generative art, shaders,
                                and interactive visualizations — all powered by WebGPU and React 19.
                        </AccordionItem>
                        <AccordionItem title="How do I get started?">
                                Browse the available experiments, tweak parameters in the control
                                panel, and see your changes reflected in real time.
                        </AccordionItem>
                        <AccordionItem title="Can I contribute?">
                                Absolutely! Check out the contributing guide in the repository to
                                get started.
                        </AccordionItem>
                </Accordion>
        )
                ...
                <div className="flex flex-col gap-4">
                        <Accordion>
                                <AccordionItem
                                        ...
                                        variant="default"
                                >
                                        Neutral grey chevron — the standard look for structural
                                        content.
                                </AccordionItem>
                        </Accordion>
                        <Accordion>
