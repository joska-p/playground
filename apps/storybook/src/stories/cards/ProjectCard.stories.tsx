...
export const Default: Story = {
        args: {
                ...
                description:
                        'A real-time wave simulation with adjustable frequency and amplitude parameters.',
                iconName: 'generative',
...
export const WithTags: Story = {
        args: {
                ...
                description:
                        'Thousands of interactive particles responding to mouse movement and gravity.',
                iconName: 'particles',
...
export const DataViz: Story = {
        args: {
                title: 'Network Graph',
                description:
                        'Interactive force-directed graph visualization of connected data nodes.',
                iconName: 'graphify',
