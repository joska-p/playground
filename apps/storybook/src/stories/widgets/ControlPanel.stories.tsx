...
const sampleSections = [
  {
    ...
    defaultOpen: true,
    controls: [
      { id: 'hue', label: 'Hue', type: 'slider' as const, value: 0.5, min: 0, max: 1, step: 0.01, onChange: fn() },
      ...
      { id: 'theme', label: 'Theme', type: 'select' as const, value: 'gruvbox', options: [
  ...
  },
  {
    ...
    icon: iconMap['box'],
    controls: [
      { id: 'position', label: 'Position', type: 'vec2' as const, value: [0, 0] as [number, number], min: -10, max: 10, step: 0.1, onChange: fn() },
      { id: 'rotation', label: 'Rotation', type: 'vec3' as const, value: [0, 0, 0] as [number, number, number], min: -180, max: 180, step: 1, onChange: fn() },
      { id: 'scale', label: 'Scale', type: 'number' as const, value: 1, min: 0.1, max: 5, step: 0.1, onChange: fn() }
    ]
  },
  {
    id: 'actions',
    ...
    icon: iconMap['wrench'],
    controls: [
      { id: 'reset', label: 'Reset All', type: 'button' as const, variant: 'danger' as const, onClick: fn() },
      { id: 'apply', label: 'Apply Preset', type: 'button' as const, variant: 'primary' as const, onClick: fn() },
      { id: 'export', label: 'Export', type: 'button' as const, variant: 'default' as const, onClick: fn() }
    ]
  }
];
