                        ...
                        <div className="flex min-h-48 items-center justify-center gap-3">
                                ...
                                >
                                        <DialogBody>
                                                ...
                                                <DialogDescription>
                                                        You can drag and drop images directly onto
                                                        the canvas to use them as texture sources.
                                                </DialogDescription>
                                        </DialogBody>
                                        <DialogActions
                                                open={openPrimary}
                                ...
                                >
                                        <DialogBody>
                                                ...
                                                <DialogDescription>
                                                        You are at 95% capacity. Please free up
                                                        space to continue creating.
                                                </DialogDescription>
                                        </DialogBody>
                                        <DialogActions
                                                variant="warning"
                                ...
                                >
                                        <DialogBody>
                                                ...
                                                <DialogDescription>
                                                        This will permanently delete all files and
                                                        cannot be undone.
                                                </DialogDescription>
                                        </DialogBody>
                                        <DialogActions
