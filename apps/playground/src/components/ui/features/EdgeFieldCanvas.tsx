 ...
 * <edge-field-canvas>
 *
 * Same shader pipeline as EdgeFieldCanvas.tsx, packaged as a plain Web Component instead of a React
 ...
 *
 * Optional attributes (all live-updatable after mount): color-cold="0.86,0.78,0.35" RGB 0-1, comma
 * separated color-hot="0.55,0.85,0.62" scale="6" noise frequency bands="8" posterization steps
 * hot-radius="440" cursor glow radius in px
 *
 * See EdgeFieldCanvas.tsx for the full feX -> shader primitive mapping — that comment block isn't
 * duplicated here, the shader itself is identical.
 */
