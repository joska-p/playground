---
title: "@repo/image-to-particles"
package: "@repo/image-to-particles"
kind: package
description: An image disintegrates into thousands of particles that tumble from the
---

# @repo/image-to-particles

> An image disintegrates into thousands of particles that tumble from the
> top of the canvas, drift under gravity, and spring back to their origin
> — turning a photograph into a moment of organized collapse and recovery.
...
- [\<internal\>](@repo.image-to-particles.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.image-to-particles.<internal>.md#element)

Defined in: [packages/image-to-particles/src/App.tsx:4](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/image-to-particles/src/App.tsx#L4)

#### Returns

[`Element`](@repo.image-to-particles.<internal>.md#element)
