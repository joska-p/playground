---
title: "@repo/three-stage"
package: "@repo/three-stage"
kind: package
description: A 3D scene explorer where geometry, materials, and lighting are all
---
...
- [\<internal\>](@repo.three-stage.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.three-stage.<internal>.md#element)

Defined in: [packages/three-stage/src/App.tsx:9](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/three-stage/src/App.tsx#L9)
...
[`Element`](@repo.three-stage.<internal>.md#element)
