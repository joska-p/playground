---
title: "@repo/pixel-engine"
package: "@repo/pixel-engine"
kind: package
description: The bare-metal core — a pure TypeScript image pipeline that translates raw
---
...
- [buffer-manager](@repo.pixel-engine.buffer-manager.md)
- [fusion-scheduler](@repo.pixel-engine.fusion-scheduler.md)
- [manipulation-factories](@repo.pixel-engine.manipulation-factories.md)
- [manipulations/manifest](@repo.pixel-engine.manipulations.manifest.md)
- [neighborhood-tiling](@repo.pixel-engine.neighborhood-tiling.md)
- [pipeline-runner](@repo.pixel-engine.pipeline-runner.md)
- [pixel-data](@repo.pixel-engine.pixel-data.md)
- [registry](@repo.pixel-engine.registry.md)
- [step-dispatcher](@repo.pixel-engine.step-dispatcher.md)
- [types](@repo.pixel-engine.types.md)
