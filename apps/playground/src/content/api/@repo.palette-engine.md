---
title: "@repo/palette-engine"
package: "@repo/palette-engine"
kind: package
description: A pure engine that maps a base color to harmonious palettes — four color
---

# @repo/palette-engine

> A pure engine that maps a base color to harmonious palettes — four color
> spaces, four harmony rules, no UI, no rendering, no opinions about how
...
- [colorSpaces](@repo.palette-engine.colorSpaces.md)
- [generatePalette](@repo.palette-engine.generatePalette.md)
- [rules/analogous](@repo.palette-engine.rules.analogous.md)
- [rules/complementary](@repo.palette-engine.rules.complementary.md)
- [rules/monochromatic](@repo.palette-engine.rules.monochromatic.md)
- [rules/triadic](@repo.palette-engine.rules.triadic.md)
- [types](@repo.palette-engine.types.md)
