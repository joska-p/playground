---
title: "@repo/fracture"
package: "@repo/fracture"
kind: package
description: A high-precision GLSL fractal renderer — exploring Mandelbrot and
  Julia sets through deep perturbation and double-single emulation.
---
...
- [\<internal\>](@repo.fracture.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.fracture.<internal>.md#element)

Defined in: [packages/fracture/src/App.tsx:13](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/fracture/src/App.tsx#L13)
...
[`Element`](@repo.fracture.<internal>.md#element)
