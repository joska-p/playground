---
title: "@repo/worker-pool"
package: "@repo/worker-pool"
kind: package
description: You write the worker. This package runs it — pooling, queuing,
...
- [mock-worker-pool](@repo.worker-pool.mock-worker-pool.md)
- [worker-pool](@repo.worker-pool.worker-pool.md)
