---
title: "@repo/art-canvas"
package: "@repo/art-canvas"
kind: package
description: A drop-bag for shader experiments — a WebGL workshop container where each
---
...
- [\<internal\>](@repo.art-canvas.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.art-canvas.<internal>.md#element)

Defined in: [packages/art-canvas/src/App.tsx:4](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/art-canvas/src/App.tsx#L4)

#### Returns

[`Element`](@repo.art-canvas.<internal>.md#element)
