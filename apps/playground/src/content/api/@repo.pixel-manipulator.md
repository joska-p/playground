---
title: "@repo/pixel-manipulator"
package: "@repo/pixel-manipulator"
kind: package
description: A ready-made React workbench for browser image manipulation — upload an image,
---
...
- [\<internal\>](@repo.pixel-manipulator.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.pixel-manipulator.<internal>.md#element)

Defined in: [packages/pixel-manipulator/src/App.tsx:7](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/pixel-manipulator/src/App.tsx#L7)
...
[`Element`](@repo.pixel-manipulator.<internal>.md#element)
