---
title: "@repo/l-system"
package: "@repo/l-system"
kind: package
description: An interactive 3D fractal visualizer that turns L-system grammars into
---
...
- [\<internal\>](@repo.l-system.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.l-system.<internal>.md#element)

Defined in: [packages/l-system/src/App.tsx:3](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/l-system/src/App.tsx#L3)

#### Returns

[`Element`](@repo.l-system.<internal>.md#element)
