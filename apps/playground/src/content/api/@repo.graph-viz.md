---
title: "@repo/graph-viz"
package: "@repo/graph-viz"
kind: package
description: A codebase rendered as a galaxy — files become spheres and boxes floating
---
...
- [\<internal\>](@repo.graph-viz.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.graph-viz.<internal>.md#element)

Defined in: [packages/graph-viz/src/App.tsx:15](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/graph-viz/src/App.tsx#L15)

#### Returns

[`Element`](@repo.graph-viz.<internal>.md#element)
