---
title: "@repo/randomart-engine"
package: "@repo/randomart-engine"
kind: package
description: A grammar-driven expression tree that compiles to both CPU pixel buffers and
---
...
- [animation/behaviors](@repo.randomart-engine.animation.behaviors.md)
- [compile/compileToGLSL](@repo.randomart-engine.compile.compileToGLSL.md)
- [compile/glslLibrary](@repo.randomart-engine.compile.glslLibrary.md)
- [format/treePrinter](@repo.randomart-engine.format.treePrinter.md)
- [grammar/registry](@repo.randomart-engine.grammar.registry.md)
- [png-export](@repo.randomart-engine.png-export.md)
- [random/SeededRandom](@repo.randomart-engine.random.SeededRandom.md)
- [render/cpu-renderer](@repo.randomart-engine.render.cpu-renderer.md)
- [tree/build](@repo.randomart-engine.tree.build.md)
- [tree/evaluate](@repo.randomart-engine.tree.evaluate.md)
- [tree/generate](@repo.randomart-engine.tree.generate.md)
- [types](@repo.randomart-engine.types.md)
