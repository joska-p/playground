---
title: "@repo/sequence-engine"
package: "@repo/sequence-engine"
kind: package
description: A pure engine that turns mathematical rules into numbered sequences —
---

# @repo/sequence-engine

> A pure engine that turns mathematical rules into numbered sequences —
> each rule a function, each sequence a `number[]`, no DOM, no rendering,
> no opinions about what comes next.
...
- [engine](@repo.sequence-engine.engine.md)
- [rules/recaman](@repo.sequence-engine.rules.recaman.md)
- [rules/registry](@repo.sequence-engine.rules.registry.md)
- [rules/types](@repo.sequence-engine.rules.types.md)
