...
[`@repo/sequence-renderer`](/discoveries/sequence-renderer/).
...
_See [@repo/sequence-renderer](/discoveries/sequence-renderer/) for the canvas rendering layer, Fourier DFT computation, and interactive controls._
