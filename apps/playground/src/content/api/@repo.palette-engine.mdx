...
management lives in
[`@repo/palette-generator`](/discoveries/palette-generator/).
...
_See [@repo/palette-generator](/discoveries/palette-generator/) for the React UI layer, color-space canvases, and interactive controls._
