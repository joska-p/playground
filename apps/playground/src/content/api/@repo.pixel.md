...
package: "@repo/pixel"
kind: package
description: A pipeline that translates raw pixel data through chains of transforms, each
---
...
- [api/pixel](@repo.pixel.api.pixel.md)
- [App](@repo.pixel.App.md)
- [hooks/usePixel](@repo.pixel.hooks.usePixel.md)
