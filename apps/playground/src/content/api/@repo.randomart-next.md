---
title: "@repo/randomart-next"
package: "@repo/randomart-next"
kind: package
description: A React window into expression-tree art — type a seed phrase, watch a
---
...
([`@repo/randomart-engine`](_media/randomart-engine)) handles all the math —
...
- [\<internal\>](@repo.randomart-next.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.randomart-next.<internal>.md#element)

Defined in: [packages/randomart-next/src/App.tsx:7](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/randomart-next/src/App.tsx#L7)

#### Returns

[`Element`](@repo.randomart-next.<internal>.md#element)
