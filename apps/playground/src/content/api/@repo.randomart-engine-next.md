---
title: "@repo/randomart-engine-next"
package: "@repo/randomart-engine-next"
kind: package
description: A grammar-driven expression-tree engine that turns a text seed into three
---
...
- [behaviors/registry](@repo.randomart-engine-next.behaviors.registry.md)
- [compileToGLSL](@repo.randomart-engine-next.compileToGLSL.md)
- [format](@repo.randomart-engine-next.format.md)
- [glsl-color-spaces](@repo.randomart-engine-next.glsl-color-spaces.md)
- [glsl-library](@repo.randomart-engine-next.glsl-library.md)
- [grammar/operators/registry](@repo.randomart-engine-next.grammar.operators.registry.md)
- [grammar/rules/registry](@repo.randomart-engine-next.grammar.rules.registry.md)
- [prng](@repo.randomart-engine-next.prng.md)
- [tree](@repo.randomart-engine-next.tree.md)
- [types](@repo.randomart-engine-next.types.md)
