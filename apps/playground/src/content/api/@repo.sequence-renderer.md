---
title: "@repo/sequence-renderer"
package: "@repo/sequence-renderer"
kind: package
description: A canvas that unfurls mathematical sequences into visible form — Fourier
---
...
- [\<internal\>](@repo.sequence-renderer.<internal>.md)

## Functions

### App()

> **App**(): [`Element`](@repo.sequence-renderer.<internal>.md#element)

Defined in: [packages/sequence-renderer/src/App.tsx:12](https://github.com/joska-p/playground/blob/f540aad548a4f8b54c8b2dc7de26bf81e2d8c83e/packages/sequence-renderer/src/App.tsx#L12)
...
[`Element`](@repo.sequence-renderer.<internal>.md#element)
