...
kind: package
description: A pure simulation engine that turns birth/survive lookup tables into
---
...
- [config](@repo.automa-engine.config.md)
- [cpu/engine](@repo.automa-engine.cpu.engine.md)
- [cpu/worker](@repo.automa-engine.cpu.worker.md)
- [creature/builtin](@repo.automa-engine.creature.builtin.md)
- [creature/registry](@repo.automa-engine.creature.registry.md)
- [gpu/createSimulationEngine](@repo.automa-engine.gpu.createSimulationEngine.md)
- [grid](@repo.automa-engine.grid.md)
- [rules/registry](@repo.automa-engine.rules.registry.md)
