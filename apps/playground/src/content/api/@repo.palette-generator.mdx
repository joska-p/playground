...
[`@repo/palette-engine`](/discoveries/palette-engine/) and
...
_See [@repo/palette-engine](/discoveries/palette-engine/) for the pure color math engine, color space definitions, and harmony rules._
