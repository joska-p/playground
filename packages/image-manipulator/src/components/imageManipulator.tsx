...
import { computeEnergy } from "../manipulations/energyMap.js";
  ...
  useEffect(() => {
    ...
    image.onload = () => {
      try {
        ...
        const pipelineResult = pipe(grayscale(), brightness(1.3))(sourceImageData);
        ...
        const energyResult = fork(computeEnergy())(sourceImageData);
