...
function Select({
    ...
    return (
        <select
            ...
            className={cn(
                'h-8 rounded-md border border-input bg-background px-2 text-xs font-mono text-foreground appearance-none cursor-pointer transition-colors duration-150 hover:border-ring outline-none focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-ring disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-muted',
