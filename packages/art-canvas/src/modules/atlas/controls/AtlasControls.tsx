                        ...
                        <ControlSection title="infos">
                                ...
                                <div>
                                        ...
                                        <p className="mt-1 text-[10px] leading-normal text-slate-400">
                                                Unified Canadian Aboriginal Syllabics (UCAS) are
                                                fundamentally geometric and rotational. A single
                                                shape is rotated (e.g., pointing ᐱ, ᐯ, ᐸ, ᐳ) to
                                                specify vowel sounds.
                                        </p>
                                ...
                                <p className="mt-0.5 max-w-xs text-[10px] leading-normal text-slate-500">
                                        Generating procedural textures mapped through the algebraic
                                        loop boundaries of Fibonacci modulations.
                                </p>
                        </ControlSection>
                </>
        );
