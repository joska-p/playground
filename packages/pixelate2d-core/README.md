...
coordinates: '/explanation/engine'
status: 'Active'
date_discovered: 2026-08-04
---

# @repo/pixelate2d-core

> The backend-agnostic heart of Pixelate2D — curried drawing pipelines, a
> closure-based engine loop, an input poll store, and CPU + GPU render drivers
