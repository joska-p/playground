import { type Camera, type Mat2D, type Rect, type Vec2, defaultCamera } from '@repo/pixelate2d-math';
...
function applyWorld(context: CanvasRenderingContext2D, camera: Camera, dpr: number, transform?: Mat2D): void {
...
function paintShape(context: CanvasRenderingContext2D, style: DrawStyle, options?: PathOptions): void {
 ...
 */
export function createCpuDriver(canvas: HTMLCanvasElement, options: CpuDriverOptions = {}): RenderDriver {
