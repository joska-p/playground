import { type Engine, type FrameCallback, type RenderDriver, type ResizeStrategy, createEngine } from '@repo/pixelate2d-core';
 ...
 */
export function useCanvasDriver(canvasRef: RefObject<HTMLCanvasElement | null>, options: UseCanvasDriverOptions): RenderDriver | null {
