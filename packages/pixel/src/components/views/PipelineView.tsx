                                        ...
                                        <table className="w-full text-left text-sm">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr className="border-border border-b">
                                                                ...
                                                                <td className="text-muted-foreground px-4 py-2.5 text-xs">
                                                                        Downscale to fit pixel
                                                                        budget, maintain aspect.
                                                                </td>
                                                        </tr>
                                                </tbody>
                                        </table>
                        ...
                        {id === 'chaining' && (
                                <div className="border-border bg-muted/30 border-l-accent) max-w-2xl rounded-lg border border-l-2 p-4">
                                        ...
                                        <p className="text-muted-foreground text-sm">
                                                Steps execute in order. Consecutive pixel-type
                                                operations are fused into a single pass for
                                                performance. Neighborhood and global ops flush
                                                pending pixel ops first. Use
                                                <code className="mx-1">snapshot</code> to capture
