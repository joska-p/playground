...
export function usePanZoom(
        ...
        useEffect(() => {
                ...
                const handlePointerMove = (e: PointerEvent) => {
                        ...
                        const pointer = createScreenToCanvas(bounds)({
                                x: e.clientX,
                                y: e.clientY
                        });
                        ...
                        if (pointers.size === 2) {
                                ...
                                if (prevPinchDist > 0) {
                                        ...
                                        if (nextZoom !== state.zoom) {
                                                ...
                                                const midNorm = createCanvasToNormalized(
                                                        bounds.width,
                                                        bounds.height
                                                )(midCanvas);
                                                ...
                                                state.pan.x -=
                                                        (midNorm.x - 0.5) * scale * bounds.width;
                                                state.pan.y -=
                                                        (midNorm.y - 0.5) * scale * bounds.height;
                                                state.zoom = nextZoom;
                                        }
                                        ...
                                        if (pinchMidpoint) {
                                                ...
                                                const panScale = scalePanWithZoom
                                                        ? 1 / state.zoom
                                                        : 1;
