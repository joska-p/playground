...
/**
 * Parses any CSS color — hex, `rgb()`/`rgba()`, `hsl()`/`hsla()`, named colors, falling back to the
 * browser's own parser — into normalized 0..1 RGBA. Unrecognized strings resolve to magenta.
 *
