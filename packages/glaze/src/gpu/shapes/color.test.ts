...
describe('parseColor', () => {
  ...
  it('parses #rrggbbaa with alpha', () => {
    expect(parseColor('#ff000080')).toEqual({ r: 1, g: 0, b: 0, a: 0.5019607843137255 });
  });

  it('parses rgb() and rgba()', () => {
    expect(parseColor('rgb(255, 128, 0)')).toEqual({ r: 1, g: 0.5019607843137255, b: 0, a: 1 });
    expect(parseColor('rgba(255, 128, 0, 0.5)')).toEqual({ r: 1, g: 0.5019607843137255, b: 0, a: 0.5 });
  });
