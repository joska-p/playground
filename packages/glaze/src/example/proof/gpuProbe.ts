...
const isGreen = (pixel: Sample): boolean => pixel[1] > 150 && pixel[1] > pixel[0] + 50 && pixel[1] > pixel[2] + 50;
const isBlue = (pixel: Sample): boolean => pixel[2] > 150 && pixel[2] > pixel[0] + 50 && pixel[2] > pixel[1] + 50;
