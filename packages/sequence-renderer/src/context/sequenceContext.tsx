import { createContext, useContext, useState, useMemo, type ComponentProps } from "react";
...
function useSequenceContext() {
  ...
  if (!context) throw new Error("useSequenceContext must be used within a SequenceProvider");
  return context;
}
