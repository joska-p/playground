    ...
    'absolute z-40 flex flex-col overflow-hidden bg-surface/80 text-foreground min-h-0 transition-all duration-300 shadow backdrop-blur',
    {
        variants: {
            ...
            position: {
                ...
                right: 'right-0 top-0 bottom-0 landscape:rounded-l-lg landscape:border-l-2 portrait:rounded-t-lg portrait:border-t-2'
            },
            size: {
                sm: '',
                md: '',
        ...
        compoundVariants: [
            ...
            // Landscape sizes
            {
                position: ['top', 'bottom'],
                size: 'sm',
                class: 'landscape:max-h-[28vh]'
            },
            {
                position: ['top', 'bottom'],
                size: 'md',
                class: 'landscape:max-h-[42vh]'
            },
            {
                position: ['top', 'bottom'],
                size: 'lg',
                class: 'landscape:max-h-[55vh]'
            },
