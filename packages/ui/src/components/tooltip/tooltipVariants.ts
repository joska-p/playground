...
export const tooltipVariants = createVariant({
  base: 'group relative after:pointer-events-none after:absolute after:bottom-[calc(100%+8px)] after:left-1/2 after:-translate-x-1/2 after:px-2.5 after:py-1 after:rounded after:text-xs after:whitespace-nowrap after:opacity-0 after:transition-opacity after:duration-150 group-hover:after:opacity-100 after:content-[attr(data-tooltip)]',
  variants: {
    variant: {
