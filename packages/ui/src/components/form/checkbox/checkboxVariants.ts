...
export const checkboxVariants = cva(
  'appearance-none shrink-0 cursor-pointer rounded border border-border bg-surface transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-70',
  {
    variants: {
      variant: {
