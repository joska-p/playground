                ...
                <div className="pointer-events-none fixed inset-0 h-screen w-screen">
                        ...
                        <svg
                                ...
                                style={{
                                        ...
                                        maskImage: 'radial-gradient(440px circle at var(--mx, 50%) var(--my, 40%), black 0%, black 18%, transparent 78%)',
                                        WebkitMaskImage:
                        ...
                        <div
                                ...
                                style={{
                                        background: 'radial-gradient(135% 110% at 50% 35%, transparent 55%, color-mix(in oklch, var(--background) 82%, transparent) 100%)'
                                }}
                        />
                </div>
        );
