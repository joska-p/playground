...
export const inputVariants = cva(
        'bg-surface rounded px-3 transition-all duration-200 disabled:pointer-events-none disabled:opacity-40 text-foreground placeholder:text-foreground-dim w-full bg-transparent py-1',
        {
                variants: {
                        variant: {
                                default: 'border-border focus-within:border-foreground-dim focus-within:ring-[3px] focus-within:ring-foreground-dim/15',
                                primary: 'border-primary focus-within:border-primary focus-within:ring-[3px] focus-within:ring-primary/15',
                                secondary: 'border-secondary focus-within:border-secondary focus-within:ring-[3px] focus-within:ring-secondary/15',
                                accent: 'border-accent focus-within:border-accent focus-within:ring-[3px] focus-within:ring-accent/15',
                                warning: 'border-warning focus-within:border-warning focus-within:ring-[3px] focus-within:ring-warning/15',
                                destructive:
                                ...
                                outline: 'border-border focus-within:border-foreground-dim focus-within:ring-[3px] focus-within:ring-foreground-dim/15'
                        },
                        size: {
