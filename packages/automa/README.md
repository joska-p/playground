...
> An interactive cellular automaton that lets you paint life onto a grid,
> watch it evolve under pluggable rules, and orbit the result in a
> full-screen React Three Fiber viewport — Conway's Game of Life as a
> playground you can reach into.
