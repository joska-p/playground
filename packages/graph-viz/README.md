...
> Interactive 3D graph visualization using React Three Fiber (R3F), drei, Zustand, and a Web Worker force-layout engine. Renders the output of `graphify` — a workspace-level dependency and concept graph.
