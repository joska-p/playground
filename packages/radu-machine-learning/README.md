...
```bash
pnpm --filter @repo/radu-machine-learning dev
```
...
Full reference: [/docs/reference/packages/radu-machine-learning/](/docs/reference/packages/radu-machine-learning/)
...
1. Add `"@repo/radu-machine-learning": "workspace:*"` to `apps/playground/package.json` (under `dependencies`).
2. Create the Astro page at `apps/playground/src/pages/projects/<category>/<slug>/index.astro`:
   ```astro
   ---
   import { Demo } from "@repo/radu-machine-learning/Demo";
   import { StrictMode } from "react";
   import BaseLayout from "../../../../layouts/base-layout.astro";
   ---

   <BaseLayout title="radu-machine-learning">
...
4. Add the `@source` directive in `apps/playground/src/styles/styles.css`:
   ```css
   @source "../../node_modules/@repo/radu-machine-learning";
   ```
