...
const navigationMenuVariants = cva("relative z-10 flex flex-1 items-center space-x-1", {
  variants: {
    variant: {
...
const NavigationMenu = ({
  ...
  return (
    <div className={cn(navigationMenuVariants({ variant, position, spacing, className }))}>
      {children}
    </div>
  );
};
...
const navigationMenuListVariants = cva("group flex flex-1 list-none items-center", {
  variants: {
    variant: {
      default: "text-foreground",
    },
...
const NavigationMenuList = ({
  ...
  return (
    <ul className={cn(navigationMenuListVariants({ variant, position, spacing, className }))}>
      {children}
    </ul>
  );
};
...
const NavigationMenuLink = ({
  ...
  return (
    <a href={href} title={title} className={cn(navigationMenuLinkVariants({ variant, className }))}>
      {children}
    </a>
  );
};
